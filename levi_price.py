...
def levi_price(plate):
	...
	get_price_submodels_per_year = get_price_submodels(meta['search']['manufacturer']['id'], meta['search']['model']['id'], meta['car']['id'], meta['car']['type']['id'])
